...
import PtkTypeForm from './Form'
import { deletePtkType, getAllPtkType } from 'src/services/ptktype'
...
const PtkType = () => {
  ...
  const getData = async () => {
    setLoading(true)
    const response = await getAllPtkType()
    setSource(response)
    setLoading(false)
  }
